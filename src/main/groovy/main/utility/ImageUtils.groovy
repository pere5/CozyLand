...
class ImageUtils {
    ...
    static BufferedImage shadeImageToMatch(BufferedImage image, int gray) {
        ...
        shadeImage(image, scaleFactor)
    }

    static BufferedImage shadeImage(BufferedImage image, float scaleFactor) {
