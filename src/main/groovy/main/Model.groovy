...
class Model {
    ...
    static Map<Shape, BufferedImage> shapeImageMap = [
            ...
            (Shape.HUT)             : ImageUtils.createImage('flaticon-hut-128.png', Main.SCALE_128),
            (Shape.SHAMAN_LODGE)    : ImageUtils.createImage('flaticon-history-64.png', Main.SCALE_128),
            (Shape.GRANARY)         : ImageUtils.createImage('flaticon-shield-64.png', Main.SCALE_128),
